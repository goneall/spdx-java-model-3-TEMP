...
public class VulnAssessmentRelationship extends Relationship  {
	...
	public Optional<Agent> getSuppliedBy() throws InvalidSPDXAnalysisException {
		Optional<Object> retval = getObjectPropertyValue(SpdxConstantsV3.SECURITY_PROP_SUPPLIED_BY);
		if (retval.isPresent()) {
	...
	public VulnAssessmentRelationship setSuppliedBy(@Nullable Agent suppliedBy) throws InvalidSPDXAnalysisException {
		setPropertyValue(SpdxConstantsV3.SECURITY_PROP_SUPPLIED_BY, suppliedBy);
		return this;
	}
	...
	public Optional<Element> getAssessedElement() throws InvalidSPDXAnalysisException {
		Optional<Object> retval = getObjectPropertyValue(SpdxConstantsV3.SECURITY_PROP_ASSESSED_ELEMENT);
		if (retval.isPresent()) {
	...
	public VulnAssessmentRelationship setAssessedElement(@Nullable Element assessedElement) throws InvalidSPDXAnalysisException {
		setPropertyValue(SpdxConstantsV3.SECURITY_PROP_ASSESSED_ELEMENT, assessedElement);
		return this;
	}
