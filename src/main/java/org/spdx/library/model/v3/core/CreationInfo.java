...
public class CreationInfo extends ModelObjectV3  {
	...
	public CreationInfo(IModelStore modelStore, String objectUri, @Nullable IModelCopyManager copyManager,
		...
		createdBys = (Collection<Agent>)(Collection<?>)this.getObjectPropertyValueCollection(SpdxConstantsV3.CORE_PROP_CREATED_BY, Agent.class);
		createdUsings = (Collection<Tool>)(Collection<?>)this.getObjectPropertyValueCollection(SpdxConstantsV3.CORE_PROP_CREATED_USING, Tool.class);
		profiles = (Collection<ProfileIdentifierType>)(Collection<?>)this.getObjectPropertyValueCollection(SpdxConstantsV3.CORE_PROP_PROFILE, ProfileIdentifierType.class);
	}
	...
	public CreationInfo setSpecVersion(@Nullable String specVersion) throws InvalidSPDXAnalysisException {
		...
		setPropertyValue(SpdxConstantsV3.CORE_PROP_SPEC_VERSION, specVersion);
		return this;
	}
	...
	public @Nullable String getDataLicense() throws InvalidSPDXAnalysisException {
		Optional<String> retval = getStringPropertyValue(SpdxConstantsV3.CORE_PROP_DATA_LICENSE);
	...
	public CreationInfo setDataLicense(@Nullable String dataLicense) throws InvalidSPDXAnalysisException {
		setPropertyValue(SpdxConstantsV3.CORE_PROP_DATA_LICENSE, dataLicense);
		return this;
	}
	...
	public @Nullable String getCreated() throws InvalidSPDXAnalysisException {
		Optional<String> retval = getStringPropertyValue(SpdxConstantsV3.CORE_PROP_CREATED);
		return retval.isPresent() ? retval.get() : null;
	}
		/**
	...
	public CreationInfo setCreated(@Nullable String created) throws InvalidSPDXAnalysisException {
		...
		setPropertyValue(SpdxConstantsV3.CORE_PROP_CREATED, created);
		return this;
	}
	...
	public static class CreationInfoBuilder extends CoreModelObjectBuilder {
		 ...
		 * @param objectUri
		 */
		public CreationInfoBuilder(ModelObjectV3 from, String objectUri) {
