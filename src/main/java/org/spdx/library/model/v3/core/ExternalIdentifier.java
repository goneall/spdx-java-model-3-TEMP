...
public class ExternalIdentifier extends ModelObjectV3  {
	...
	public ExternalIdentifier(IModelStore modelStore, String objectUri, @Nullable IModelCopyManager copyManager,
		...
		identifierLocators = (Collection<String>)(Collection<?>)this.getObjectPropertyValueCollection(SpdxConstantsV3.CORE_PROP_IDENTIFIER_LOCATOR, String.class);
	}
	...
	public @Nullable ExternalIdentifierType getExternalIdentifierType() throws InvalidSPDXAnalysisException {
		Optional<Enum<?>> retval = getEnumPropertyValue(SpdxConstantsV3.CORE_PROP_EXTERNAL_IDENTIFIER_TYPE);
		if (retval.isPresent()) {
	...
	public ExternalIdentifier setExternalIdentifierType(@Nullable ExternalIdentifierType externalIdentifierType) throws InvalidSPDXAnalysisException {
		...
		setPropertyValue(SpdxConstantsV3.CORE_PROP_EXTERNAL_IDENTIFIER_TYPE, externalIdentifierType);
		return this;
	}
	...
	public Optional<String> getIssuingAuthority() throws InvalidSPDXAnalysisException {
		return getStringPropertyValue(SpdxConstantsV3.CORE_PROP_ISSUING_AUTHORITY);
	}
	/**
	...
	public ExternalIdentifier setIssuingAuthority(@Nullable String issuingAuthority) throws InvalidSPDXAnalysisException {
		setPropertyValue(SpdxConstantsV3.CORE_PROP_ISSUING_AUTHORITY, issuingAuthority);
		return this;
	}
	...
	public @Nullable String getIdentifier() throws InvalidSPDXAnalysisException {
		Optional<String> retval = getStringPropertyValue(SpdxConstantsV3.CORE_PROP_IDENTIFIER);
	...
	public ExternalIdentifier setIdentifier(@Nullable String identifier) throws InvalidSPDXAnalysisException {
		...
		setPropertyValue(SpdxConstantsV3.CORE_PROP_IDENTIFIER, identifier);
		return this;
	}
	...
	public static class ExternalIdentifierBuilder extends CoreModelObjectBuilder {
		 ...
		 * @param objectUri
		 */
		public ExternalIdentifierBuilder(ModelObjectV3 from, String objectUri) {
