...
public class Artifact extends Element  {
	...
	public Artifact(IModelStore modelStore, String objectUri, @Nullable IModelCopyManager copyManager,
		...
		originatedBys = (Collection<Agent>)(Collection<?>)this.getObjectPropertyValueCollection(SpdxConstantsV3.CORE_PROP_ORIGINATED_BY, Agent.class);
		standards = (Collection<String>)(Collection<?>)this.getObjectPropertyValueCollection(SpdxConstantsV3.CORE_PROP_STANDARD, String.class);
	}
	...
	public Optional<Agent> getSuppliedBy() throws InvalidSPDXAnalysisException {
		Optional<Object> retval = getObjectPropertyValue(SpdxConstantsV3.CORE_PROP_SUPPLIED_BY);
		if (retval.isPresent()) {
	...
	public Artifact setSuppliedBy(@Nullable Agent suppliedBy) throws InvalidSPDXAnalysisException {
		setPropertyValue(SpdxConstantsV3.CORE_PROP_SUPPLIED_BY, suppliedBy);
		return this;
	}
	...
	public Optional<String> getValidUntilTime() throws InvalidSPDXAnalysisException {
		return getStringPropertyValue(SpdxConstantsV3.CORE_PROP_VALID_UNTIL_TIME);
	}
	/**
	...
	public Artifact setValidUntilTime(@Nullable String validUntilTime) throws InvalidSPDXAnalysisException {
		setPropertyValue(SpdxConstantsV3.CORE_PROP_VALID_UNTIL_TIME, validUntilTime);
		return this;
	}
	...
	public Optional<String> getBuiltTime() throws InvalidSPDXAnalysisException {
		return getStringPropertyValue(SpdxConstantsV3.CORE_PROP_BUILT_TIME);
	}
	/**
	...
	public Artifact setBuiltTime(@Nullable String builtTime) throws InvalidSPDXAnalysisException {
		setPropertyValue(SpdxConstantsV3.CORE_PROP_BUILT_TIME, builtTime);
		return this;
	}
	...
	public Optional<String> getReleaseTime() throws InvalidSPDXAnalysisException {
		return getStringPropertyValue(SpdxConstantsV3.CORE_PROP_RELEASE_TIME);
	}
	/**
	...
	public Artifact setReleaseTime(@Nullable String releaseTime) throws InvalidSPDXAnalysisException {
		setPropertyValue(SpdxConstantsV3.CORE_PROP_RELEASE_TIME, releaseTime);
		return this;
	}
	...
	public static class ArtifactBuilder extends ElementBuilder {
		 ...
		 * @param objectUri
		 */
		public ArtifactBuilder(ModelObjectV3 from, String objectUri) {
